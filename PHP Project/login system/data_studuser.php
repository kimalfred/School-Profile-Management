...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index_user.html">Home Page</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index_user.html">Courses</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="index_user.html">Contacts</a>        
      </ul>
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $student['pnum']; ?></td>
                                                <td>
                                                    <a href="data_viewuser.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>                                                   
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
